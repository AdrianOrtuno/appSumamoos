...
type Match struct {
	SeasonID              season.Season         `json:"seasonID"`              // SeasonID is the ID associated with the current season of league.
	QueueID               queue.Queue           `json:"queueID"`               // QueueID is a constant that refers to the queue.
	GameID                int64                 `json:"gameID"`                // GameID is the ID of the requested game.
	ParticipantIdentities []ParticipantIdentity `json:"participantIdentities"` // Array of player identities in requested game.
	GameVersion           string                `json:"gameVersion"`           // Version that the game was played on.
	PlatformID            string                `json:"platformID"`            // PlatformID
	GameMode              string                `json:"gameMode"`              // GameMode
	MapID                 int                   `json:"mapID"`                 // MapID is a constant of the map played on.
	GameType              string                `json:"gameType"`              // GameType
	Teams                 []TeamStats           `json:"teams"`                 // Teams
	Participants          []Participant         `json:"participants"`          // Participants
	GameDuration          types.Milliseconds    `json:"gameDuration"`          // GameDuration is the duration of the game in milliseconds
	GameCreation          types.Milliseconds    `json:"gameCreation"`          // GameCreation is when game was created in epoch
}
